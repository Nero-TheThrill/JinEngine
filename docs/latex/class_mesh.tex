...
GPU-\/backed draw-\/able geometry (VAO/\+VBO/\+EBO) with optional instancing.  
...
\begin{DoxyCompactList}\small\item\em Creates a mesh from vertex and optional index data. \end{DoxyCompactList}\item 
\mbox{\hyperlink{class_mesh_a5efe4da1a4c0971cfb037bd70304c303}{\texorpdfstring{$\sim$}{\string~}\+Mesh}} ()
\begin{DoxyCompactList}\small\item\em Destroys GPU resources (VAO/\+VBO/\+EBO and instance buffers). \end{DoxyCompactList}\item 
glm\+::vec2 \mbox{\hyperlink{class_mesh_a4a8b413a54afd1dcb83df7c5e2bbefc8}{Get\+Local\+Bounds\+Half\+Size}} () const
\begin{DoxyCompactList}\small\item\em Returns half of the local-\/space AABB size (X/Y). \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Defines per-\/instance vertex attributes (mat4, color, uv offset/scale). \end{DoxyCompactList}\item 
void \mbox{\hyperlink{class_mesh_abf84fe4ef735490769268685087e0e32}{Draw}} () const
\begin{DoxyCompactList}\small\item\em Issues a non-\/instanced draw call. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Issues an instanced draw call. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Uploads vertex/index data and configures VAO/\+VBO/\+EBO. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes local-\/space half-\/size from vertex positions. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Updates per-\/instance buffers (model, color, UV offset/scale). \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em \doxylink{struct_vertex}{Vertex} array object for non-\/instanced draws. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \doxylink{struct_vertex}{Vertex} buffer object (positions + UVs). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Optional index buffer object. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \doxylink{struct_vertex}{Vertex} array configured for instanced draws. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Streams\+: \mbox{[}0\mbox{]}=mat4, \mbox{[}1\mbox{]}=color, \mbox{[}2\mbox{]}=uv offset, \mbox{[}3\mbox{]}=uv scale. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{class_mesh_a3153eeca2bbde0037c365662bbeb52f1}{use\+Index}}
\begin{DoxyCompactList}\small\item\em True if EBO is used. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Primitive topology used for draw calls. \end{DoxyCompactList}\item 
glm\+::vec2 \mbox{\hyperlink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{local\+Half\+Size}}
\begin{DoxyCompactList}\small\item\em Precomputed half-\/size of local AABB (XY). \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
GPU-\/backed draw-\/able geometry (VAO/\+VBO/\+EBO) with optional instancing. 

\doxylink{class_mesh}{Mesh} uploads vertex/index data to GPU buffers and exposes non-\/instanced and instanced draw paths. It also computes a conservative local half-\/size used for culling or bounds estimates.
...
Creates a mesh from vertex and optional index data. 


\begin{DoxyParams}{Parameters}
{\em vertices} & The vertex array (position + UV). \\
\hline
{\em indices} & Optional index array; if empty, the mesh is drawn non-\/indexed. \\
\hline
{\em primitive\+Type} & Primitive topology (default = Triangles). \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
Destroys GPU resources (VAO/\+VBO/\+EBO and instance buffers). 
...
\begin{DoxyParams}{Parameters}
{\em instanced} & True if instance attributes are needed. \\
\hline
\end{DoxyParams}
...
Computes local-\/space half-\/size from vertex positions. 

For empty input, defaults to \{0.\+5, 0.\+5\}; for a single vertex, a tiny size. Otherwise, builds an AABB over positions and takes half of its extent.


\begin{DoxyParams}{Parameters}
{\em vertices} & \doxylink{struct_vertex}{Vertex} array used for bounds. \\
\hline
\end{DoxyParams}


Definition at line \mbox{\hyperlink{_mesh_8h_source_l00133}{133}} of file \mbox{\hyperlink{_mesh_8h_source}{Mesh.\+h}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00134\ \ \ \ \ \{}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (vertices.empty())}
\DoxyCodeLine{00136\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{localHalfSize}}\ =\ glm::vec2(0.5f);}
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (vertices.size()\ ==\ 1)}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00142\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{localHalfSize}}\ =\ glm::vec2(0.0001f);}
\DoxyCodeLine{00143\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00144\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ glm::vec2\ minPos\ =\ vertices[0].position;}
\DoxyCodeLine{00147\ \ \ \ \ \ \ \ \ glm::vec2\ maxPos\ =\ vertices[1].position;}
\DoxyCodeLine{00148\ }
\DoxyCodeLine{00149\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ v\ :\ vertices)}
\DoxyCodeLine{00150\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00151\ \ \ \ \ \ \ \ \ \ \ \ \ glm::vec2\ pos\ =\ v.position;}
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ \ \ \ \ minPos\ =\ glm::min(minPos,\ pos);}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ \ \ \ \ maxPos\ =\ glm::max(maxPos,\ pos);}
\DoxyCodeLine{00154\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00155\ }
\DoxyCodeLine{00156\ \ \ \ \ \ \ \ \ glm::vec2\ size\ =\ maxPos\ -\/\ minPos;}
\DoxyCodeLine{00157\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{localHalfSize}}\ =\ size\ *\ 0.5f;}
\DoxyCodeLine{00158\ \ \ \ \ \}}
...
Issues a non-\/instanced draw call. 

Uses indexed draw if \doxylink{class_mesh_a3153eeca2bbde0037c365662bbeb52f1}{use\+Index} is true; otherwise, array draw. 
...
\hline
\end{DoxyParams}
Requires \doxylink{class_mesh_a45673d65011bf8f70c0f7de2a37d7f6c}{Update\+Instance\+Buffer} to have uploaded the per-\/instance data. 
...
Returns half of the local-\/space AABB size (X/Y). 

Computed from vertex positions on construction.

\begin{DoxyReturn}{Returns}
Half-\/size of local bounds. 
\end{DoxyReturn}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00078\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{localHalfSize}};\ \}}
...
Defines per-\/instance vertex attributes (mat4, color, uv offset/scale). 

Called during initialization to set divisors/attribute pointers into \doxylink{class_mesh_a33810b4cdfaae0d1eb1ada168cd3c1a5}{instance\+VBO} streams. 
...
Uploads vertex/index data and configures VAO/\+VBO/\+EBO. 


\begin{DoxyParams}{Parameters}
{\em vertices} & \doxylink{struct_vertex}{Vertex} array. \\
\hline
{\em indices} & Index array (optional). \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
Also computes \doxylink{class_mesh_ab9d13fdb38eedf8e33aefa9f61056e95}{local\+Half\+Size} via \doxylink{class_mesh_ad097772f26af95c8f7070cbb0e8cbfef}{Compute\+Local\+Bounds}. 
\end{DoxyNote}
...
Updates per-\/instance buffers (model, color, UV offset/scale). 


\begin{DoxyParams}{Parameters}
{\em transforms} & Array of model matrices (one per instance). \\
\hline
{\em colors} & Array of per-\/instance colors. \\
\hline
{\em uv\+Offsets} & Array of per-\/instance UV offsets. \\
\hline
{\em uv\+Scales} & Array of per-\/instance UV scales. \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
All arrays must have the same length (instance\+Count). 
\end{DoxyNote}
...
Optional index buffer object. 



Definition at line \mbox{\hyperlink{_mesh_8h_source_l00174}{174}} of file \mbox{\hyperlink{_mesh_8h_source}{Mesh.\+h}}.
...
\doxylink{struct_vertex}{Vertex} array configured for instanced draws. 
...
Streams\+: \mbox{[}0\mbox{]}=mat4, \mbox{[}1\mbox{]}=color, \mbox{[}2\mbox{]}=uv offset, \mbox{[}3\mbox{]}=uv scale. 
...
Precomputed half-\/size of local AABB (XY). 
...
\doxylink{struct_vertex}{Vertex} array object for non-\/instanced draws. 



Definition at line \mbox{\hyperlink{_mesh_8h_source_l00172}{172}} of file \mbox{\hyperlink{_mesh_8h_source}{Mesh.\+h}}.
...
\doxylink{struct_vertex}{Vertex} buffer object (positions + UVs). 



Definition at line \mbox{\hyperlink{_mesh_8h_source_l00173}{173}} of file \mbox{\hyperlink{_mesh_8h_source}{Mesh.\+h}}.
